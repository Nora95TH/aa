...
public class insTsk extends AppCompatActivity {
    ...
    public void addButtonClicked(View v){
        ...
        db.execSQL("insert into "+ dbHandler.TABLE_NAME + "("+ dbHandler.COLUMN_NAME + "," +
                dbHandler.COLUMN_PHONE + "," + dbHandler.COLUMN_PASS + "," + dbHandler.COLUMN_EMAIL + "," + dbHandler.COLUMN_CREDIT + ") VALUES (?,?)", new String [] {nameStr, phoneStr, passStr, emailStr, creditStr});
